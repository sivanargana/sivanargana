...
export default function Banner({ name, title, specialization, totalExperience }: BannerProps) {
  ...
  return (
  <>
  <section className="relative overflow-hidden px-6 pt-34 pb-16 md:min-h-screen md:px-12 lg:px-16 flex flex-col">
    ...
    <div className="flex-auto relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-12">
